...
checkpoint = ModelCheckpoint('../HistoryAndWeightFiles/Inception_model_weights_v1.h5', monitor='val_loss', verbose=1, save_best_only=True, mode='min')
...
with open("../HistoryAndWeightFiles/Inception_Model_History_v1.json","w") as f:  ##modelin accuracy değerlerini jsona yazar
    json.dump(histt,f) 
#%%Model Load
#model.load_weights('../HistoryAndWeightFiles/CNN_Model_Weights_v3.h5') #kayıtlı değişkenleri modele yükler

with codecs.open("../HistoryAndWeightFiles/Inception_Model_History_v1.json","r",encoding = "utf-8") as f: #accuracy ve lost değişkenlerini tekrar yükler
