...
#with open("CNN_Model_History.json","w") as f:  ##modelin accuracy değerlerini jsona yazar
#    json.dump(history.history,f)
#histt=pd.Series(history.history).to_json()
#with open("CNN_Model_History3.json","w") as f:  ##modelin accuracy değerlerini jsona yazar
#    json.dump(histt,f)
#%%Model Load
#model.load_weights('CNN_Model_Weights.hdf5') #kayıtlı değişkenleri modele yükler
#
#with codecs.open("CNN_Model_History.json","r",encoding = "utf-8") as f: #accuracy ve lost değişkenlerini tekrar yükler
...
predictImage(model, test_files, 38)
