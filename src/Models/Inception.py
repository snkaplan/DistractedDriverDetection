...
def createModel():
    ...
    tower_3=Conv2D(64,(1,1),padding='same',activation='relu')(input_image)
    tower_3=Conv2D(64,(1,1),padding='same',activation='relu')(tower_3)
    
    mid_1=keras.layers.concatenate([tower_1,tower_2,tower_3],axis=3)
    flat_1=Flatten()(mid_1)
   
    dense_2=Dense(150,activation='relu')(flat_1)
    dense_3=Dense(50,activation='relu')(dense_2)
    output=Dense(NUMBER_CLASSES,activation='softmax')(dense_3)
...
checkpoint = ModelCheckpoint('../HistoryAndWeightFiles/Inception_model_weights_v3.h5', monitor='val_loss', verbose=1, save_best_only=True, mode='min')
...
with open("../HistoryAndWeightFiles/Inception_Model_History_v3.json","w") as f:  ##modelin accuracy değerlerini jsona yazar
    json.dump(histt,f) 
#%%Model Load
#model.load_weights('../HistoryAndWeightFiles/Indception_Model_Weights_v2.h5') #kayıtlı değişkenleri modele yükler

with codecs.open("../HistoryAndWeightFiles/Inception_Model_History_v3.json","r",encoding = "utf-8") as f: #accuracy ve lost değişkenlerini tekrar yükler
...
predictImage(model, test_files,17)
