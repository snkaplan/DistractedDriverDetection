...
checkpoint = ModelCheckpoint('../HistoryAndWeightFiles/InceptionV3_model_weights_v2.h5', monitor='val_loss', verbose=1, save_best_only=True, mode='min')
...
with open("../HistoryAndWeightFiles/InceptionV3_Model_History_v2.json","w") as f:  ##modelin accuracy değerlerini jsona yazar
    json.dump(histt,f) 
#%%Model Load
#model.load_weights('../HistoryAndWeightFiles/Indception_Model_Weights_v2.h5') #kayıtlı değişkenleri modele yükler

with codecs.open("../HistoryAndWeightFiles/InceptionV3_Model_History_v2.json","r",encoding = "utf-8") as f: #accuracy ve lost değişkenlerini tekrar yükler
